...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'SM Upsell'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'fbb2ce249f9621ed1b724c9dca33a8df'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'ca84bbd31d66e4dd3bcc8a581732e247'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_script_tags,write_script_tags,read_products,write_products,read_orders,write_orders,read_inventory,write_inventory,read_themes'),
...
//                'address' => 'https://upsell-de.smartosc.com/webhook/orders-fulfilled'
//            ],
    ],
    ...
    */
    ...
    'scripttags' => [
            /*[
                'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://js-aplenty.com/bar.js'),
