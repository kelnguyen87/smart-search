        ...
        <form class="needs-validation" action="{{url('/').'/offer/edit'}}" method="post" id="offer-form" novalidate>
            ...
            <div class="row">
                    ...
                    <div class="box box-primary form-trigger-event">
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <div class="add-to-cart-event">
                                            <label for="Label_trigger_place_cart">
                                                <input id="Label_trigger_place_cart" type="radio" name="trigger_place"
                                                       value="product-detail" class="flat-red" value="cart"
                                                       @if($offer->trigger_place == 'product-detail') checked @endif>
                                            </label>
                                            <div class="desc">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <div class="add-to-checkout-event">
                                            <label for="Label_trigger_place_checkout">
                                                <input type="radio" id="Label_trigger_place_checkout"
                                                       name="trigger_place" value="cart" class="flat-red"
                                                       @if($offer->trigger_place == 'cart') checked @endif>
                                            </label>
                                            <div class="desc">
                                    ...
                                    <div class="col-md-6">
                                        <div class="cross-sell-type">
                                            <label for="Label_offer_type_cross">
                                                <input id="Label_offer_type_cross" type="radio" name="offer_type"
                                                       value="cross-sell" class="flat-red"
                                                       @if($offer->type == 'cross-sell') checked @endif>Cross-sell
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="cross-sell-type">
                                            <label for="Label_offer_type_up">
                                                <input id="Label_offer_type_up" type="radio" name="offer_type"
                                                       value="up-sell" class="flat-red"
                                                       @if($offer->type == 'up-sell') checked @endif>Upsell
                                            </label>
                            ...
                            <div class="trigger-product-list form-group">
                                ...
                                <p>You can restrict this offer to certain products. Without choosing products your
                                    upsell will happen every time the above event occurs.</p>
                                <div class="input-group sm-invalid product-list">
                                    <input class="form-control" type="text" name="trigger_products"
                                           id="trigger_product_input" value="{{$triggerProduct}}"
                                           placeholder="Select Product" required/>
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-primary" id="trigger-product"
                                                data-toggle="modal"
                                                data-target="#product-modal">Select Product
                                        </button>
                                    </div>
                            ...
                            <div>
                                <table id="selected_trigger" class="table table-bordered table-list-selected">
                                    <tbody></tbody>
                                </table>
                                <div class="pagination-sm inline ">
                                    <ul id="selected_trigger_pagination" class="pagination">
                    ...
                    <div class="box box-primary form-offer-list">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="offer_title" class="form-control" value="{{$offer->title}}"
                                       required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="offer_description" class="form-control"
                                          rows="3">{{$offer->description}}</textarea>
                            </div>
                            <div class="offer-product-list form-group">
                                <label>Offer products</label>
                                <div class="input-group sm-invalid product-list">
                                    <input class="form-control" type="text" name="offer_products"
                                           id="offer-product-input" value="{{$offerProduct}}"
                                           placeholder="Select Product" required>
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-primary" id="offer-product"
                                                data-toggle="modal"
                                                data-target="#product-modal">Select Product
                                        </button>
                                    </div>
                        ...
                        <div>
                            <table id="selected_offer" class="table table-bordered table-list-selected">
                                <tbody></tbody>
                            </table>
                            <div class="pagination-sm inline ">
                                <ul id="selected_offer_pagination" class="pagination">
                ...
                <input type="text" name="start-time" id="edit-start-time"
                       value="{{date('d-m-Y',strtotime($offer->start_day))}}" hidden>
                <input type="text" name="end-time" id="edit-end-time"
                       value="{{date('d-m-Y',strtotime($offer->end_day))}}" hidden>
                <div class="col-md-4">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" name="date-range"
                                           id="date-range-edit"
                                           value="{{date('m/d/Y',strtotime($offer->start_day))}} - {{date('m/d/Y',strtotime($offer->end_day))}}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="selected_complete" class="btn btn-primary pull-left">Continue with
                            selected
                            products
                        </button>
                    </div>
...
@section('page-script')
    ...
    <script type="text/javascript">
        function editCb(start, end) {
            $('#edit-start-time').val(start.format('D-M-YYYY'));
            $('#edit-end-time').val(end.format('D-M-YYYY'));
        }

        // add logic for date range
        $('#date-range-edit').daterangepicker({
            ranges: {
                'Today': [moment(), moment()],
        ...
        $('#date-range-edit').on("focusin", function () {
            $(this).prop('readonly', true);
        });
        $('#date-range-edit').on("focusout", function () {
