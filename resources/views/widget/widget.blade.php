@if (sizeof($listVariant)>0)
    <div class="crossell-upsell-smart">
        <div class="widget">
            <div class="infor">
                    ...
                    <div class="swiper-wrapper">
                        @foreach($data as $value)
                            @if(sizeof($value->variants)>1)
                                                ...
                                                <div class="product-item__content">
                                                        ...
                                                        <a href="{{'/products/'.$value->handle}}" title="">
                                                            <div class="product-item__image-wrapper">
                                                                <img class="product-item__image"
                                                                     @if (!empty($value->image)){{$value->image->src}}@else {{asset('images/150.png')}} @endif
                                                                     alt="{{$value->title}}">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                    ...
                                                    <div class="product-item__details">
                                                        ...
                                                        <button type="button" class="add-to-cart" offer-type="{{$type}}"
                                                                variant-id="{{$item->id}}"
                                                                trigger-id="{{$variant_mapping[$item->id]}}"
                                ...
                                @endforeach
                            @else
                                @if(in_array($value->variants[0]->id,$listVariant))
                                    <div class="swiper-slide">
                                        <div class="product-item">
                                            <div class="product-item__content">
                                                <figure class="product-item__figure">
                                                ...
                                                <div class="product-item__details">
                                                    ...
                                                    <button type="button" class="add-to-cart" offer-type="{{$type}}"
                                                            ...
                                                            trigger-id="{{$variant_mapping[$value->variants[0]->id]}}"
                                                            data-action="add-to-cart">{{$buttonTitle}}</button>
                                                    <div class="product__form-status" style="display: none">
                                                        <p class="product__form-message">{{$addedAlert}}</p>
                                                        <a href="#" data-action="close-form-status"
                                                           class="product__form-continue button button--full button--black">{{$continueText}}</a>
                                                        <br>
                                                        <a href="/cart" class="button button--full button--black">{{$goCartText}}</a>
                                                    </div>
                                                </div>
