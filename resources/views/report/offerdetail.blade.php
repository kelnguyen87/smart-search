...
<section class="content container-fluid">
    ...
    <div class="box box-list">
        <div class="box-body">
            <div class="chart-group">
                <div class="box-header"><h3 class="box-title">Number of views/Added to cart/Purchase</h3></div>
                <div class="chart">
    ...
    <div class="box box-list">
        <div class="box-body">
            <div class="chart-group">
                <div class="box-header"><h3 class="box-title">Amount purchase</h3></div>
                <div class="chart">
